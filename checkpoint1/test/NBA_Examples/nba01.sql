...
--simple join
SELECT FIRSTNAME, LASTNAME, WEIGHT, BIRTHDATE FROM PLAYERS P1,PLAYERS P2;


SELECT FIRSTNAME, LASTNAME, WEIGHT, BIRTHDATE FROM (SELECT FIRSTNAME FROM PLAYERS) P1,(SELECT LASTNAME FROM PLAYERS) P2;
